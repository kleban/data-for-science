...
Для початку потрібно створити обліковий запис на <github.com> та розмістити матеріали у репозиторії. Наступним етапом є налаштування роботи GitHub Actions 
